...
def build_main_embed(uid: str, display_name: str = None) -> discord.Embed:
    ...
    if current_key and current_key in CLASS_DEFS:
        ...
        class_name_cn = cd["name_cn"]
        class_name_en = cd["name_en"]
    else:
    ...
    header_parts = [
        f"**Welcome, {display_name or 'Adventurer'}**",
        f"----------------------------",
        f"{class_emoji} **{class_name_cn} / {class_name_en}**  |  \u2b50 Lv.**{level}**",
        f"\U0001f4b0 **{bal:,}** coins",
    ]
...
# ══════════════════════════════════════════════════════════════
# MMORPGMainView — Unified Control Panel (19 subsystems, 4 rows)
# Row 0 (danger):   Dungeon | Boss | PVP | Bounty
# Row 1 (success):  Stats | Class | Skills | Equip | Titles
# Row 2 (primary):  Work | Shop | Gacha | Market | Guild
# Row 3 (secondary): Quest | Bag | Pets | Achieve | Cosmetics
# ══════════════════════════════════════════════════════════════
class MMORPGMainView(discord.ui.View):
    ...
    @discord.ui.button(label="Class 职业", emoji="\U0001f9d9", style=discord.ButtonStyle.primary, row=0, custom_id="mmorpg_main:class")
    ...
    @discord.ui.button(label="Stats 属性", emoji="\U0001f4ca", style=discord.ButtonStyle.primary, row=0, custom_id="mmorpg_main:stats")
    ...
    # ═══════════════════════════════════════════════════════════
    # Row 1: Combat / Adventure  (success)
    # ═══════════════════════════════════════════════════════════
    @discord.ui.button(label="Boss 首领", emoji="\U0001f479", style=discord.ButtonStyle.success, row=1, custom_id="mmorpg_main:boss")
    ...
    @discord.ui.button(label="Dungeon 地牢", emoji="\U0001f3f0", style=discord.ButtonStyle.success, row=1, custom_id="mmorpg_main:dungeon")
    ...
    @discord.ui.button(label="Quest 任务", emoji="\U0001f4cb", style=discord.ButtonStyle.success, row=1, custom_id="mmorpg_main:quest")
    ...
    @discord.ui.button(label="Bag 背包", emoji="\U0001f392", style=discord.ButtonStyle.success, row=1, custom_id="mmorpg_main:inv")
    ...
    # ═══════════════════════════════════════════════════════════
    # Row 2: Equipment / Growth / Titles  (secondary)
    # ═══════════════════════════════════════════════════════════
    @discord.ui.button(label="Equipment 装备", emoji="\U0001f6e1\uFE0F", style=discord.ButtonStyle.secondary, row=2, custom_id="mmorpg_main:equip")
    ...
    @discord.ui.button(label="Skills 技能", emoji="\u26a1", style=discord.ButtonStyle.secondary, row=2, custom_id="mmorpg_main:skills")
    ...
    @discord.ui.button(label="Titles 称号", emoji="\U0001f3c6", style=discord.ButtonStyle.secondary, row=2, custom_id="mmorpg_main:titles")
    async def _titles_callback(self, interaction: discord.Interaction, button: discord.ui.Button):
        from cogs.mmorpg_titles import TitlesHubView
        view = TitlesHubView(self.uid, main_view=self)
        embed = discord.Embed(
            title="\U0001f3c6 Titles / 称号",
    ...
    @discord.ui.button(label="Achievements 成就", emoji="\U0001f396\uFE0F", style=discord.ButtonStyle.secondary, row=2, custom_id="mmorpg_main:achievements")
    async def _achievements_callback(self, interaction: discord.Interaction, button: discord.ui.Button):
    ...
    @discord.ui.button(label="World Boss", emoji="\U0001f409", style=discord.ButtonStyle.secondary, row=2, custom_id="mmorpg_main:worldboss")
    ...
    # ═══════════════════════════════════════════════════════════
    # Row 3: Systems / Social  (primary)
    # ═══════════════════════════════════════════════════════════
    @discord.ui.button(label="Fishing 钓鱼", emoji="\U0001f3a3", style=discord.ButtonStyle.primary, row=3, custom_id="mmorpg_main:fishing")
    ...
    @discord.ui.button(label="Check-in 签到", emoji="\U0001f4c5", style=discord.ButtonStyle.primary, row=3, custom_id="mmorpg_main:checkin")
    ...
    @discord.ui.button(label="Pet 宠物", emoji="\U0001f43e", style=discord.ButtonStyle.primary, row=3, custom_id="mmorpg_main:pet")
    ...
    @discord.ui.button(label="Guild 公会", emoji="\U0001f3f0", style=discord.ButtonStyle.primary, row=3, custom_id="mmorpg_main:guild_mmo")
    ...
    @discord.ui.button(label="Auction 拍卖", emoji="\U0001f48e", style=discord.ButtonStyle.primary, row=3, custom_id="mmorpg_main:auction")
    ...
    # ═══════════════════════════════════════════════════════════
    # Row 4: Endgame / Advanced  (secondary)
    # ═══════════════════════════════════════════════════════════
    @discord.ui.button(label="Enchant 附魔", emoji="\u2728", style=discord.ButtonStyle.secondary, row=4, custom_id="mmorpg_main:enchant")
    async def _enchant_callback(self, interaction: discord.Interaction, button: discord.ui.Button):
    ...
    @discord.ui.button(label="Ranked 排位", emoji="\U0001f3c6", style=discord.ButtonStyle.secondary, row=4, custom_id="mmorpg_main:ranked")
    async def _ranked_callback(self, interaction: discord.Interaction, button: discord.ui.Button):
...
EQUIPMENT_SHOP = {
    "weapon": [
        ...
        {"name": "长剑 Long Sword", "quality": "common", "stat": "atk", "stat_value": 10, "price": 14, "emoji": "⚔️"},
        {"name": "暴风之剑 B.F. Sword", "quality": "rare", "stat": "atk", "stat_value": 25, "price": 52, "emoji": "⚔️"},
        {"name": "幽梦之灵 Youmuu's Ghostblade", "quality": "rare", "stat": "atk", "stat_value": 20, "price": 44, "emoji": "💨"},
        {"name": "无尽之刃 Infinity Edge", "quality": "epic", "stat": "atk", "stat_value": 45, "price": 136, "emoji": "🔥"},
        {"name": "饮血剑 Bloodthirster", "quality": "epic", "stat": "atk", "stat_value": 40, "price": 128, "emoji": "❤️"},
        {"name": "三相之力 Trinity Force", "quality": "epic", "stat": "atk", "stat_value": 35, "price": 133, "emoji": "✨"},
        {"name": "神圣分离者 Divine Sunderer", "quality": "epic", "stat": "atk", "stat_value": 35, "price": 132, "emoji": "⚡"},
        {"name": "暮刃 Duskblade", "quality": "legendary", "stat": "atk", "stat_value": 55, "price": 160, "emoji": "🌑"},
    ],
    "helmet": [
        {"name": "抗魔斗篷 Null-Magic Mantle", "quality": "common", "stat": "def", "stat_value": 8, "price": 18, "emoji": "🪖"},
        {"name": "布甲 Cloth Armor", "quality": "common", "stat": "def", "stat_value": 5, "price": 12, "emoji": "🪖"},
        {"name": "负极斗篷 Negatron Cloak", "quality": "rare", "stat": "def", "stat_value": 15, "price": 36, "emoji": "🪖"},
        {"name": "深渊面具 Abyssal Mask", "quality": "rare", "stat": "def", "stat_value": 20, "price": 44, "emoji": "🎭"},
        {"name": "振奋盔甲 Spirit Visage", "quality": "epic", "stat": "def", "stat_value": 30, "price": 116, "emoji": "💚"},
        {"name": "适应性头盔 Adaptive Helm", "quality": "epic", "stat": "def", "stat_value": 25, "price": 112, "emoji": "🧠"},
        {"name": "兰顿之兆 Randuin's Omen", "quality": "epic", "stat": "def", "stat_value": 35, "price": 108, "emoji": "🛡️"},
        {"name": "女妖面纱 Banshee's Veil", "quality": "epic", "stat": "def", "stat_value": 25, "price": 104, "emoji": "🔮"},
        {"name": "灭世者的死亡之帽 Rabadon's Deathcap", "quality": "legendary", "stat": "def", "stat_value": 40, "price": 144, "emoji": "👑"},
    ],
    "armor": [
        {"name": "锁子甲 Chain Vest", "quality": "common", "stat": "def", "stat_value": 10, "price": 32, "emoji": "🛡️"},
        {"name": "守望者铠甲 Warden's Mail", "quality": "rare", "stat": "def", "stat_value": 15, "price": 40, "emoji": "🛡️"},
        {"name": "日炎斗篷 Sunfire Cape", "quality": "epic", "stat": "def", "stat_value": 30, "price": 108, "emoji": "☀️"},
        {"name": "荆棘之甲 Thornmail", "quality": "epic", "stat": "def", "stat_value": 35, "price": 108, "emoji": "🌹"},
        {"name": "亡者的板甲 Dead Man's Plate", "quality": "epic", "stat": "def", "stat_value": 30, "price": 116, "emoji": "💀"},
        {"name": "冰霜之心 Frozen Heart", "quality": "epic", "stat": "def", "stat_value": 30, "price": 100, "emoji": "❄️"},
        {"name": "石像鬼石板甲 Gargoyle Stoneplate", "quality": "epic", "stat": "def", "stat_value": 25, "price": 100, "emoji": "🗿"},
        {"name": "狂徒铠甲 Warmog's Armor", "quality": "legendary", "stat": "def", "stat_value": 45, "price": 120, "emoji": "🛡️"},
        {"name": "守护天使 Guardian Angel", "quality": "legendary", "stat": "def", "stat_value": 35, "price": 112, "emoji": "👼"},
    ],
    "leggings": [
        {"name": "草鞋 Boots of Speed", "quality": "common", "stat": "hp", "stat_value": 15, "price": 12, "emoji": "👖"},
        {"name": "水银之靴 Mercury's Treads", "quality": "rare", "stat": "hp", "stat_value": 30, "price": 44, "emoji": "👖"},
        {"name": "忍者足具 Ninja Tabi", "quality": "rare", "stat": "hp", "stat_value": 25, "price": 44, "emoji": "👖"},
        {"name": "狂战士胫甲 Berserker's Greaves", "quality": "rare", "stat": "hp", "stat_value": 25, "price": 44, "emoji": "👖"},
        {"name": "明朗之靴 Ionian Boots", "quality": "rare", "stat": "hp", "stat_value": 20, "price": 36, "emoji": "👖"},
        {"name": "轻灵之靴 Boots of Swiftness", "quality": "epic", "stat": "hp", "stat_value": 35, "price": 100, "emoji": "💨"},
        {"name": "铁板靴 Plated Steelcaps", "quality": "rare", "stat": "hp", "stat_value": 30, "price": 40, "emoji": "👖"},
        {"name": "法穿鞋 Sorcerer's Shoes", "quality": "rare", "stat": "hp", "stat_value": 20, "price": 44, "emoji": "👖"},
    ],
    "boots": [
        {"name": "速度之靴 Boots", "quality": "common", "stat": "hp", "stat_value": 10, "price": 12, "emoji": "👢"},
        {"name": "疾行之靴 Boots of Mobility", "quality": "rare", "stat": "hp", "stat_value": 25, "price": 40, "emoji": "👢"},
        {"name": "明朗之靴CDR Cosmic Drive", "quality": "rare", "stat": "hp", "stat_value": 20, "price": 36, "emoji": "👢"},
        {"name": "幽梦之靴 Youmuu's Greaves", "quality": "epic", "stat": "hp", "stat_value": 35, "price": 104, "emoji": "👢"},
        {"name": "无尽之靴 Infinity Treads", "quality": "epic", "stat": "hp", "stat_value": 30, "price": 100, "emoji": "👢"},
        {"name": "暗行者之靴 Prowler's Greaves", "quality": "legendary", "stat": "hp", "stat_value": 45, "price": 128, "emoji": "🌑"},
        {"name": "风暴之靴 Stormrazor Boots", "quality": "rare", "stat": "hp", "stat_value": 20, "price": 40, "emoji": "👢"},
        {"name": "神谕之靴 Oracle's Greaves", "quality": "epic", "stat": "hp", "stat_value": 30, "price": 96, "emoji": "👢"},
    ],
    "accessory": [
        {"name": "暴击手套 Brawler's Gloves", "quality": "common", "stat": "crit,hp", "stat_value": "5,10", "price": 16, "emoji": "💍"},
        {"name": "灵巧披风 Cloak of Agility", "quality": "rare", "stat": "crit,hp", "stat_value": "10,15", "price": 32, "emoji": "💍"},
        {"name": "狂热 Zeal", "quality": "rare", "stat": "crit,hp", "stat_value": "12,10", "price": 48, "emoji": "💍"},
        {"name": "幻影之舞 Phantom Dancer", "quality": "epic", "stat": "crit,hp", "stat_value": "20,20", "price": 104, "emoji": "💫"},
        {"name": "斯塔缇克电刃 Statikk Shiv", "quality": "epic", "stat": "crit,hp", "stat_value": "18,15", "price": 104, "emoji": "⚡"},
        {"name": "卢安娜的飓风 Runaan's Hurricane", "quality": "epic", "stat": "crit,hp", "stat_value": "18,15", "price": 104, "emoji": "🌪️"},
        {"name": "水银饰带 Quicksilver Sash", "quality": "rare", "stat": "crit,hp", "stat_value": "8,20", "price": 52, "emoji": "💍"},
        {"name": "中娅沙漏 Zhonya's Hourglass", "quality": "legendary", "stat": "crit,hp", "stat_value": "15,35", "price": 120, "emoji": "⏳"},
        {"name": "破败王者之刃 Blade of the Ruined King", "quality": "legendary", "stat": "crit,hp", "stat_value": "12,30", "price": 128, "emoji": "🗡️"},
        {"name": "界弓 The Collector", "quality": "legendary", "stat": "crit,hp", "stat_value": "25,10", "price": 120, "emoji": "🏹"},
    ],
}
...
GACHA_POOL = {
    "weapon": [
        {"name": "多兰之刃 Doran's Blade", "quality": "common", "stat": "atk", "stat_value": 8, "emoji": "⚔️"},
        {"name": "长剑 Long Sword", "quality": "common", "stat": "atk", "stat_value": 10, "emoji": "⚔️"},
        {"name": "暴风之剑 B.F. Sword", "quality": "rare", "stat": "atk", "stat_value": 25, "emoji": "⚔️"},
        {"name": "幽梦之灵 Youmuu's Ghostblade", "quality": "rare", "stat": "atk", "stat_value": 20, "emoji": "💨"},
        {"name": "无尽之刃 Infinity Edge", "quality": "epic", "stat": "atk", "stat_value": 45, "emoji": "🔥"},
        {"name": "饮血剑 Bloodthirster", "quality": "epic", "stat": "atk", "stat_value": 40, "emoji": "❤️"},
        {"name": "三相之力 Trinity Force", "quality": "epic", "stat": "atk", "stat_value": 35, "emoji": "✨"},
        {"name": "神圣分离者 Divine Sunderer", "quality": "epic", "stat": "atk", "stat_value": 35, "emoji": "⚡"},
        {"name": "暮刃 Duskblade", "quality": "legendary", "stat": "atk", "stat_value": 55, "emoji": "🌑"},
        {"name": "诸神黄昏 Ragnarok", "quality": "legendary", "stat": "atk", "stat_value": 70, "emoji": "🔥"},
    ],
    "helmet": [
        {"name": "抗魔斗篷 Null-Magic Mantle", "quality": "common", "stat": "def", "stat_value": 8, "emoji": "🪖"},
        {"name": "布甲 Cloth Armor", "quality": "common", "stat": "def", "stat_value": 5, "emoji": "🪖"},
        {"name": "负极斗篷 Negatron Cloak", "quality": "rare", "stat": "def", "stat_value": 15, "emoji": "🪖"},
        {"name": "深渊面具 Abyssal Mask", "quality": "rare", "stat": "def", "stat_value": 20, "emoji": "🎭"},
        {"name": "振奋盔甲 Spirit Visage", "quality": "epic", "stat": "def", "stat_value": 30, "emoji": "💚"},
        {"name": "适应性头盔 Adaptive Helm", "quality": "epic", "stat": "def", "stat_value": 25, "emoji": "🧠"},
        {"name": "兰顿之兆 Randuin's Omen", "quality": "epic", "stat": "def", "stat_value": 35, "emoji": "🛡️"},
        {"name": "女妖面纱 Banshee's Veil", "quality": "epic", "stat": "def", "stat_value": 25, "emoji": "🔮"},
        {"name": "灭世者的死亡之帽 Rabadon's Deathcap", "quality": "legendary", "stat": "def", "stat_value": 40, "emoji": "👑"},
        {"name": "全知者之冠 Crown of Omniscience", "quality": "legendary", "stat": "def", "stat_value": 50, "emoji": "👁️"},
    ],
    "armor": [
        {"name": "锁子甲 Chain Vest", "quality": "common", "stat": "def", "stat_value": 10, "emoji": "🛡️"},
        {"name": "守望者铠甲 Warden's Mail", "quality": "rare", "stat": "def", "stat_value": 15, "emoji": "🛡️"},
        {"name": "日炎斗篷 Sunfire Cape", "quality": "epic", "stat": "def", "stat_value": 30, "emoji": "☀️"},
        {"name": "荆棘之甲 Thornmail", "quality": "epic", "stat": "def", "stat_value": 35, "emoji": "🌹"},
        {"name": "亡者的板甲 Dead Man's Plate", "quality": "epic", "stat": "def", "stat_value": 30, "emoji": "💀"},
        {"name": "冰霜之心 Frozen Heart", "quality": "epic", "stat": "def", "stat_value": 30, "emoji": "❄️"},
        {"name": "石像鬼石板甲 Gargoyle Stoneplate", "quality": "epic", "stat": "def", "stat_value": 25, "emoji": "🗿"},
        {"name": "狂徒铠甲 Warmog's Armor", "quality": "legendary", "stat": "def", "stat_value": 45, "emoji": "🛡️"},
        {"name": "守护天使 Guardian Angel", "quality": "legendary", "stat": "def", "stat_value": 35, "emoji": "👼"},
        {"name": "创世神之铠 Aegis of Creation", "quality": "legendary", "stat": "def", "stat_value": 60, "emoji": "✨"},
    ],
    "leggings": [
        {"name": "草鞋 Boots of Speed", "quality": "common", "stat": "hp", "stat_value": 15, "emoji": "👖"},
        {"name": "水银之靴 Mercury's Treads", "quality": "rare", "stat": "hp", "stat_value": 30, "emoji": "👖"},
        {"name": "忍者足具 Ninja Tabi", "quality": "rare", "stat": "hp", "stat_value": 25, "emoji": "👖"},
        {"name": "狂战士胫甲 Berserker's Greaves", "quality": "rare", "stat": "hp", "stat_value": 25, "emoji": "👖"},
        {"name": "明朗之靴 Ionian Boots", "quality": "rare", "stat": "hp", "stat_value": 20, "emoji": "👖"},
        {"name": "轻灵之靴 Boots of Swiftness", "quality": "epic", "stat": "hp", "stat_value": 35, "emoji": "💨"},
        {"name": "铁板靴 Plated Steelcaps", "quality": "rare", "stat": "hp", "stat_value": 30, "emoji": "👖"},
        {"name": "法穿鞋 Sorcerer's Shoes", "quality": "rare", "stat": "hp", "stat_value": 20, "emoji": "👖"},
        {"name": "终末护腿 Leggings of Finality", "quality": "legendary", "stat": "hp", "stat_value": 60, "emoji": "💀"},
    ],
    "boots": [
        {"name": "速度之靴 Boots", "quality": "common", "stat": "hp", "stat_value": 10, "emoji": "👢"},
        {"name": "疾行之靴 Boots of Mobility", "quality": "rare", "stat": "hp", "stat_value": 25, "emoji": "👢"},
        {"name": "明朗之靴CDR Cosmic Drive", "quality": "rare", "stat": "hp", "stat_value": 20, "emoji": "👢"},
        {"name": "幽梦之靴 Youmuu's Greaves", "quality": "epic", "stat": "hp", "stat_value": 35, "emoji": "👢"},
        {"name": "无尽之靴 Infinity Treads", "quality": "epic", "stat": "hp", "stat_value": 30, "emoji": "👢"},
        {"name": "暗行者之靴 Prowler's Greaves", "quality": "legendary", "stat": "hp", "stat_value": 45, "emoji": "🌑"},
        {"name": "风暴之靴 Stormrazor Boots", "quality": "rare", "stat": "hp", "stat_value": 20, "emoji": "👢"},
        {"name": "神谕之靴 Oracle's Greaves", "quality": "epic", "stat": "hp", "stat_value": 30, "emoji": "👢"},
        {"name": "光速行者 Lightspeed Strider", "quality": "legendary", "stat": "hp", "stat_value": 55, "emoji": "⚡"},
    ],
    "accessory": [
        {"name": "暴击手套 Brawler's Gloves", "quality": "common", "stat": "crit,hp", "stat_value": "5,10", "emoji": "💍"},
        {"name": "灵巧披风 Cloak of Agility", "quality": "rare", "stat": "crit,hp", "stat_value": "10,15", "emoji": "💍"},
        {"name": "狂热 Zeal", "quality": "rare", "stat": "crit,hp", "stat_value": "12,10", "emoji": "💍"},
        {"name": "幻影之舞 Phantom Dancer", "quality": "epic", "stat": "crit,hp", "stat_value": "20,20", "emoji": "💫"},
        {"name": "斯塔缇克电刃 Statikk Shiv", "quality": "epic", "stat": "crit,hp", "stat_value": "18,15", "emoji": "⚡"},
        {"name": "卢安娜的飓风 Runaan's Hurricane", "quality": "epic", "stat": "crit,hp", "stat_value": "18,15", "emoji": "🌪️"},
        {"name": "水银饰带 Quicksilver Sash", "quality": "rare", "stat": "crit,hp", "stat_value": "8,20", "emoji": "💍"},
        {"name": "中娅沙漏 Zhonya's Hourglass", "quality": "legendary", "stat": "crit,hp", "stat_value": "15,35", "emoji": "⏳"},
        {"name": "破败王者之刃 Blade of the Ruined King", "quality": "legendary", "stat": "crit,hp", "stat_value": "12,30", "emoji": "🗡️"},
        {"name": "界弓 The Collector", "quality": "legendary", "stat": "crit,hp", "stat_value": "25,10", "emoji": "🏹"},
        {"name": "创世之心 Heart of Genesis", "quality": "legendary", "stat": "crit,hp", "stat_value": "30,50", "emoji": "💖"},
    ],
}
